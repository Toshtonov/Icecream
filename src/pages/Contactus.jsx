  ...
  return (
    <div className="w-full">
      ...
      <section className="py-16 bg-white text-center px-4 sm:px-6 lg:px-8">
        ...
        {/* Contact Content */}
        <div className="mt-10 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-start">
          {/* Left Info */}
          <div className="space-y-6 text-left">
            {/* Location */}
            <div className="flex items-start gap-4 bg-white shadow rounded-xl p-4 sm:p-6">
          ...
          {/* Right Form */}
          <form className="bg-white rounded-xl shadow p-4 sm:p-6 space-y-4">
            ...
            <textarea
              ...
              className="border rounded-lg px-4 py-2 w-full text-sm focus:outline-pink-500"
            ></textarea>
            <button className="bg-pink-500 hover:bg-pink-600 text-white px-6 py-3 rounded-full font-medium transition w-full sm:w-auto">
              Submit Now →
            </button>
          </form>
        </div>
