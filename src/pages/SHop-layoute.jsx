...
const products = [
  { id: 1, name: "Classic Vanilla Ice Cream", desc: "Creamy vanilla ice cream topped with cherry.", price: 4.99, img: "src/images/prodect-4.png", rating: 4.9 },
  { id: 2, name: "Chocolate Brownie Sundae", desc: "Rich chocolate ice cream with chunks of brownie.", price: 5.49, img: "src/images/prodect-1.png", rating: 4.9 },
  { id: 3, name: "Strawberry Shortcake", desc: "Strawberry ice cream layered with shortcake.", price: 5.29, img: "src/images/prodect-2.png", rating: 4.9 },
  { id: 4, name: "Mint Chocolate Chip Cone", desc: "Refreshing mint ice cream with chocolate chips.", price: 3.99, img: "src/images/prodect-3.png", rating: 4.9 },
  { id: 5, name: "Strawberry Sundae", desc: "Strawberry ice cream with fresh strawberries.", price: 5.99, img: "src/images/41.png", rating: 4.9 },
  { id: 6, name: "Chocolate Chip Cookie Cone", desc: "Chocolate chip cookie dough ice cream in a cone.", price: 4.49, img: "src/images/isecream.png", rating: 4.9 },
  { id: 7, name: "Blueberry Bliss", desc: "Blueberry ice cream with creamy texture.", price: 6.49, img: "src/images/prodect-5.png", rating: 5 },
  { id: 8, name: "Caramel Crunch", desc: "Caramel swirls with crunchy toppings.", price: 6.99, img: "src/images/prodect-6.png", rating: 5 },
];
...
export default function ShopPage() {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 p-4 md:p-6 bg-gray-50 w-[95%] mx-auto">
        {/* Sidebar */}
        <aside className="w-full lg:w-64 bg-white shadow rounded-lg p-4 order-2 lg:order-1">
          <div className="mb-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
            <div className="relative w-full sm:w-auto">
              <input
                type="text"
                placeholder="Search"
                className="w-full sm:w-64 border rounded-full pl-10 pr-4 py-2 text-sm"
                value={search}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {currentProducts.map((p) => (
              ...
              >
                ...
                <p className="text-sm text-gray-500 line-clamp-2">{p.desc}</p>
