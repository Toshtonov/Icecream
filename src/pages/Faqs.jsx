    ...
    <div className="w-full">
      ...
      <section className="bg-pink-600 relative overflow-hidden py-16 w-[100%] text-center text-white">
        ...
        <div className="relative z-10 w-[70%] mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          />
       <img className="absolute left-[25%] top-[20%]" src="src/images/359.png" alt="" />
...
<img className="absolute right-[30%] bottom-[20%]" src="src/images/360.png" alt="" />
          {/* Right Ice Cream */}
           <img 
       ...
       <div className="w-[100%] py-15 flex relative justify-center items-center">
        ...
        <img src="src/images/round.png" className="absolute left-[20%] bottom-[25%]" alt="" />
        <img src="src/images/tringl.png" className="absolute right-[20%] top-[22%]" alt="" />
      </div>
    </div>
  );
}
