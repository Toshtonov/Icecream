    ...
    <div className="bg-[#683292]  p-9">
      ...
      <div className="w-[100%]  flex justify-center ">
        <div className="w-[70%]  flex justify-between items-center py-9">
          <div>
            <img src="src/images/Group 1 (1).png" alt="" />
          </div>
          <div className="flex">
            <div>
        ...
        <img src="src/images/977b0075aff18e92a704e7c5b3f4e5bb61216844.png" className="absolute left-0 w-50 " alt="" />
      </div>
      <div className="w-[70%] h-[2px] bg-[#74737326] m-auto"></div>
      <div>
        <p className="flex justify-center text-[80%] text-white">Copyright © 2024 BlackRise Themes Inc All rights reserved.</p>
